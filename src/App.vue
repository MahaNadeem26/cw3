...
export default {
  ...
  created() {
    ...
    fetch("https://webcw2individual.herokuapp.com/collection/products", {
      method: "GET",
      headers: {
...
.add-cart button {
  ...
  justify-content: center;
  align-items: center;
  background-color: rgb(108, 41, 82);
  letter-spacing: 2px;
  margin-top: 14px;
  border-radius: 10%;
  display: flex;
...
.cart-button button {
  ...
  justify-content: center;
  align-items: center;
  background-color: rgb(124, 33, 101);
  letter-spacing: 2px;
  margin-top: 10px;
  margin-left: 1200px;
  border-radius: 10%;
