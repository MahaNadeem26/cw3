      ...
      <div class="product-box">
        <div v-for="product in cart" :key="product.id">
          <div class="product-img">
            <figure>
              <img style="height: 100px" v-bind:src="product.img" />
            </figure>
          </div>
...
.classes-back button {
  ...
  justify-content: center;
  align-items: center;
  background-color: rgb(154, 51, 120);
  letter-spacing: 2px;
  margin-top: 10px;
  margin-left: 1200px;
  border-radius: 10%;
...
.cart-button button {
  ...
  justify-content: center;
  align-items: center;
  background-color: rgb(126, 40, 107);
  letter-spacing: 2px;
  margin-top: 10px;
  margin-left: 1200px;
  border-radius: 10%;
...
.CheckOut-form button {
  background-color: rgb(123, 49, 97);
  color: white;
  padding: 16px 20px;
  margin: 8px 0;
  border: 1;
